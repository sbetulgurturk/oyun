...
public class NesneYap : MonoBehaviour {
    ...
    void KarakterinKonumu()
    {
        ...
        for (int i = 0; i < engeller.Length; i++)
        {
            if (engeller[i].transform.position.y == 0)
            {
                ...
                engeller[i].transform.position = new Vector3(destekler[0].transform.position.x, destekler[0].transform.position.y,
                    destekler[0].transform.position.z);
